...
public class VerticalStepperView extends FrameLayout implements IStepperView {
    ...
    public VerticalStepperView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, moe.feng.common.stepperview.R.styleable.VerticalStepperView,
                    defStyleAttr, moe.feng.common.stepperview.R.style.Widget_Stepper);

            mNormalColor = a.getColor(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_normal_color, mNormalColor);
            mActivatedColor = a.getColor(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_activated_color, mActivatedColor);
            mAnimationDuration = a.getInt(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_animation_duration, mAnimationDuration);
            mAnimationEnabled = a.getBoolean(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_enable_animation, true);
            mLineColor = a.getColor(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_line_color, mLineColor);
            mErrorColor = a.getColor(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_error_highlight_color, mErrorColor);
            mAlwaysShowSummary = a.getBoolean(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_show_summary_always, mAlwaysShowSummary);

            if (a.hasValue(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_done_icon)) {
                mDoneIcon = a.getDrawable(moe.feng.common.stepperview.R.styleable.VerticalStepperView_step_done_icon);
            }
    ...
    private void prepareListView(Context context) {
        ...
        mListView.setPadding(0, getResources().getDimensionPixelSize(moe.feng.common.stepperview.R.dimen.stepper_margin_top), 0, 0);

        mListView.addItemDecoration(new VerticalSpaceItemDecoration(
                getResources().getDimensionPixelSize(moe.feng.common.stepperview.R.dimen.vertical_stepper_item_space_height)));
     ...
     */
    public @Nullable
    CharSequence getErrorText(int index) {
        if (mErrorTexts != null) {
